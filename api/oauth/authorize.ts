...
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    label { display: block; font-size: 13px; font-weight: 500; margin-bottom: 6px; color: #d4d4d4; }
    input[type="text"] {
      width: 100%;
      padding: 10px 12px;
      background: #0a0a0a;
...
<body>
  <div class="card">
    ...
    <form method="POST" action="/oauth/authorize" id="form">
      ...
      <input type="text" id="api_key" name="api_key" placeholder="sw_..." required autocomplete="off">
      <div class="error" id="error"></div>
      <button type="submit">Connect to Claude</button>
    </form>
    <p class="help">Generate an API key at <a href="https://sciweave.com/settings" target="_blank">sciweave.com/settings</a></p>
  </div>
</body>
</html>`);
}
